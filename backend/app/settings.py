...
class Settings(BaseSettings):
    ...
    hotel_api_key: Optional[str] = Field(default=None, alias="HOTEL_API_KEY")       # e.g., RapidAPI key
    hotel_api_host: Optional[str] = Field(default=None, alias="HOTEL_API_HOST")     # e.g., "skyscanner50.p.rapidapi.com"
    hotel_api_endpoint: Optional[str] = Field(default=None, alias="HOTEL_API_ENDPOINT")  # Full endpoint URL if needed
    ...
    # Verifier thresholds
    min_rating: float = Field(default=3.9, alias="MIN_RATING")  # Filter out low-rated POIs
